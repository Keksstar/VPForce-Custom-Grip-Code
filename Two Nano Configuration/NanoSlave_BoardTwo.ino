...
ISR (SPI_STC_vect)
{
 ...
 if (pullcount == 2) // byte 2 buttons
    ...
    else if (pullcount == 3) //byte 3, axis signal from A6 on board 2
    {
    ...
    else if (pullcount == 4) //byte 4, axis signal from A6 on board 2
    {
      //Swap the following two lines comments if axis is unused: 
      //SPDR = 0; 
    ...
    else if (pullcount == 5) //byte 5, axis signal from A7 on board 2
    {
      //Swap the following two lines comments if axis is unused: 
      //SPDR = 0; 
      SPDR = lowerbit2;
    ...
    else if (pullcount == 6) //byte 6, axis signal from A7 on board 2
    {
      //Swap the following two lines comments if axis is unused: 
      //SPDR = 0; 
      SPDR = upperbit2;
